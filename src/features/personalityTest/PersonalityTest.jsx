...
import {
  createPersonalityQuestionId,
  getPersonalityTestQuestions,
  savePersonalityTestQuestions,
} from "./personalityTestStore";
...
export default function PersonalityTest() {
  ...
  const [questions, setQuestions] = useState(() => getPersonalityTestQuestions());
  ...
  const persistQuestions = (nextQuestions) => {
    ...
    savePersonalityTestQuestions(nextQuestions);
  };
  ...
  return (
    <section className="space-y-5">
      <div>
        <h2 className="text-xl font-bold text-[#9a2119]">Personality Test Questions</h2>
        <p className="text-sm text-slate-500">
          Manage personality test questions as a normal quiz-style question list.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        ...
        <Table
          ...
          locale={{ emptyText: "No personality test questions added yet." }}
        />
      </div>
